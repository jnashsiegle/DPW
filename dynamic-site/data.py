...
class Data(object):
	...
	#first instance of CharClass
		...
		death_knight.desc = '<p>Death knights (introduced in Wrath of the Lich King) boast powerful melee abilities, as well as plate armor. These warriors supplement their strength with dark magic. Calling upon a rune system of magic, the death knight may summon unholy, blood, and frost spells. The criterion for creating a death knight is the existence of a level 55+ character on the player\'s account on any realm[1].</p>'
